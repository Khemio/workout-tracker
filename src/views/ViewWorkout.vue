<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
      ...
      <div class="flex flex-col items-center p-8 tounded-md shadow-md bg-light-grey relative">
      ...
      <div class="mt-10 p-8 rounded-md flex flex-col item-center bg-light-grey shadow-md">
        ...
        <!-- Strength Training -->
        <div v-if="data.workoutType === 'strength'"
        ...
        <!-- Cardio Training -->
        <div v-else-if="data.workoutType === 'cardio'"
        class="flex flex-col gap-y-4 w-full">
          <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row"
          v-for="(item, index) in data.exercises" :key="index">
            <div class="flex flex-2 flex-col md:w-1/3">
