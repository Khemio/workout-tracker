  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <form @submit.prevent="register" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
      ...
      <div class="flex flex-col mb-2">
        <label for="email" class="mb-1 text-sm tex-at-light-green">Email</label>
        <input 
          type="text" 
          required 
      ...
      <div class="flex flex-col mb-2">
        <label for="password" class="mb-1 text-sm tex-at-light-green">Password</label>
        <input 
          type="password" 
          required 
          class="p-2 text-grey-500 focus:outline-none" 
      ...
      <div class="flex flex-col mb-2">
        <label for="confirmPassword" class="mb-1 text-sm tex-at-light-green">Confirm Password</label>
        <input 
          type="password" 
          required 
          class="p-2 text-grey-500 focus:outline-none" 
